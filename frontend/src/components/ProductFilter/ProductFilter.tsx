...
const ProductFilter: React.FC<IProductFilterProps> = ({ number_of_products, title }): React.ReactElement => {
    ...
    const productTypes = ['Blouses', 'T-shirts', 'Robes', 'Coots', 'Jackets', 'Dungarees', 'Shirts', 'Sweatshirts', 'Swimwear'];
    ...
    const sortOptions = ['Featured', 'Best selling', 'Alphabetically A-Z', 'Alphabetically Z-A', 'Price, low to high', 'Price, high to low'];

    const handleFilterChange = (selected: string[], setSelected: React.Dispatch<React.SetStateAction<string[]>>, value: string) => {
