...
const EmptyProductList: React.FC = () => {
  ...
  return (
    <EmptyListContainer>
      <SVG.Cross color={colors.DARK_GREEN} />
      <EmptyListTitle>No Products Found</EmptyListTitle>
      <EmptyListText>Try adjusting your filters or explore our new arrivals.</EmptyListText>
