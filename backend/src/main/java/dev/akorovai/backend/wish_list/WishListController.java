...
public class WishListController {
    ...
    public ResponseEntity<ResponseRecord> checkWishlistStatus(@PathVariable Long productId) {
        boolean isInWishlist = wishListService.checkWishlistStatus(productId);
        return ResponseEntity.ok(new ResponseRecord(HttpStatus.OK.value(), isInWishlist));
    }
}