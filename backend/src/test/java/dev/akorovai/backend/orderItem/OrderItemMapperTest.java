...
class OrderItemMapperTest {
	...
	void testToResponse() {
		...
		when(product.getLinks()).thenReturn(new String[]{"link1", "link2"});
	...
	void testToResponseSet() {
		...
		when(product1.getLinks()).thenReturn(new String[]{"link1"});
		...
		when(product2.getLinks()).thenReturn(new String[]{"link2"});
